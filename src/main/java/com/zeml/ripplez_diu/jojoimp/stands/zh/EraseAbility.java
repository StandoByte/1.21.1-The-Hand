...
public class EraseAbility extends StandEntityAbility {

    public EraseAbility(AbilityType<?> abilityType, AbilityId abilityId) {
        super(abilityType, abilityId, ErasingAbility::new);
    ...
    public static class ErasingAbility extends StandEntityHeavyPunchChargedAbility.StandEntityChargedHeavy{
